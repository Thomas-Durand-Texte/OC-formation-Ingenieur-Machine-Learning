...
\date[]{3 Juin 2023\\\vspace{18mm}\\\tit{thomas.durandtexte@protonmail.com}}
...
\begin{frame}[t, label=BaseDonnees]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=90mm]{SQL_querry.png}} ;
...
\begin{frame}[t, label=MissingValues]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=80mm]{ratio_isnull.pdf}} ;
...
\begin{frame}[t, label=QPerYear]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=90mm]{q_per_y.pdf}} ;
...
\begin{frame}[t, label=QlenPerYear]
	...
	\begin{tikzpicture}
		...
		\only<1-2>{
			\node at (\midX,\midY) {\includegraphics[width=90mm]{arr_length_per_year_body.pdf}} ;
		}

		\node<2> at (\midX, 15mm) {\alert{Longueur} des corps de texte \alert{relativement constante} dans le temps} ;

		\only<3-4>{
			\node at (\midX,\midY) {\includegraphics[width=90mm]{arr_length_per_year_title.pdf}} ;
		}
...
\begin{frame}[t, label=TagsPerY]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY-5mm) {\includegraphics[width=80mm]{tags_per_y.pdf}} ;
...
\begin{frame}[t, label=TagsMostUsed]
	...
	\begin{tikzpicture}
		...
		\only<1>{
			...
			\node at (\midX,\midY) {\includegraphics[width=90mm]{most_used_tags.pdf}} ;
		}
		\only<2->{
			\node at (\midX,\midY) {\includegraphics[width=90mm]{most_used_tags_per_year.pdf}} ;
		}
...
\begin{frame}[t, label=ProportionTagsInDataset]
	...
	\begin{tikzpicture}
		...
		\node<3-> at (\midX,40mm) {\includegraphics[width=80mm]{prop_tags.pdf}} ;
...
\begin{frame}[t, label=ClassifieursResults]
	...
	\begin{tikzpicture}
		...
		\node<2-> at (\midX,\midY) {\includegraphics[width=90mm]{F1_scores_models.pdf}} ;
...
\begin{frame}[t, label=PCA]
	...
	\begin{tikzpicture}
		...
		\node<2> at (\midX,\midY) {\includegraphics[width=90mm]{ebouli_tfidf.pdf}} ;
		\node<3-> at (\midX,\midY) {\includegraphics[width=90mm]{F1_scores_PCA.pdf}} ;
...
\begin{frame}[t, label=Régularisation]
	...
	\begin{tikzpicture}
		...
		\node<2-> at (\midX,\midY) {\includegraphics[width=90mm]{F1_scores_regularisation.pdf}} ;
...
\begin{frame}[t, label=vocabLength]
	...
	\begin{tikzpicture}
		...
		\node<2-> at (\midX,\midY) {\includegraphics[width=90mm]{F1_scores_vocab_length.pdf}} ;
...
\begin{frame}[t, label=OptimThreshold]
	...
	\begin{tikzpicture}
		...
		\node<2-> at (\midX,\midY) {\includegraphics[width=90mm]{F1_scores_decision_threshold.pdf}} ;
...
\begin{frame}[t, label=Encodeurs]
	...
	\begin{tikzpicture}
		...
		\node<9-> at (\midX,\midY) {\includegraphics[width=90mm]{F1_scores_vectorizer.pdf}} ;
