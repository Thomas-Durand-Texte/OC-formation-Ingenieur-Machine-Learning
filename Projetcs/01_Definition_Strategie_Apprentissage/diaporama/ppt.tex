...
\begin{frame}[t]
	...
	\vfill
	\only<1>{\includegraphics[width=100mm]{dates/cell-1.png}}%
	\only<2>{\includegraphics[width=100mm]{dates/cell-1_out.png}}%
	\only<3>{\includegraphics[width=100mm]{dates/cell-2.png}}%
	\only<4>{\includegraphics[width=100mm]{dates/cell-3.png}}%
	\only<5>{\includegraphics[width=100mm]{dates/cell-3_out.png}}%
	\only<6>{\includegraphics[width=100mm]{dates/cell-4.png}}%
	\only<7>{\includegraphics[width=100mm]{dates/cell-4_out.png}}%
	\only<8>{\includegraphics[width=100mm]{dates/cell-5.png}}%
	\only<9>{\includegraphics[width=100mm]{dates/cell-6.png}}%
	\only<10>{\includegraphics[width=100mm]{dates/cell-6_out.png}}%
	\only<11>{\includegraphics[width=100mm]{dates/cell-7.png}}%
	\vfill
...
\begin{frame}
	...
	\only<1>{ \vspace*{0mm} \includegraphics[width=100mm]{GitHub.png}}
