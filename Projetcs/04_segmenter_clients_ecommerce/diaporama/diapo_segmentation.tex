...
\date[]{27 Avril 2023\\\vspace{18mm}\\\tit{thomas.durandtexte@protonmail.com}}
...
\begin{frame}[t, label=BaseDonnees]
	...
	\begin{tikzpicture}
		...
		\node[draw, rounded corners, fill=black!4] at (\midX, \midY) { \includegraphics[width=90mm]{data_diagram.png}} ;
...
\begin{frame}[t, label=n_orders_vs_tim]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=90mm]{explore/N_orders_vs_time.pdf}} ;
		...
		\visible<2->{
			\begin{scope}[yshift=1.5mm]
				...
				\node[myOrng, text centered] at (70mm, 47mm) {Croissance importante} ;
			\end{scope}
		}
	\end{tikzpicture}
\end{frame}
...
\begin{frame}[t, label=ordersStatus]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=90mm]{explore/order_status.pdf}} ;
...
\begin{frame}[t, label=varRecence]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/Recence.pdf}} ;
...
\begin{frame}[t, label=varFrequence]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/Frequence.pdf}} ;
...
\begin{frame}[t, label=varMontant]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/Montant.pdf}} ;
...
\begin{frame}[t, label=pairplotRFM]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/pair_plot.png}} ;
...
\begin{frame}[t, label=RFMquantiles]
	...
	\begin{tikzpicture}
		...
		\visible<2->{
			\node at (\midX+5mm,\midY) {\includegraphics[width=70mm] {explore/quantiles.png}} ;
		}


		\visible<3>{
			\draw[myOrng, thick, rounded corners] (39mm+5.4mm, 22mm) rectangle ++(18mm, 47mm) ;
			\node[myOrng] at (\midX,15mm) {Forte proportion de fréquences basses} ;
		}
	\end{tikzpicture}
\end{frame}
...
\begin{frame}[t, label=varPaymentType]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/payment_type.pdf}} ;
...
\begin{frame}[t, label=varReviewScore]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/review_score.pdf}} ;
...
\begin{frame}[t, label=varDeliveryDelay]
	...
	\begin{tikzpicture}
		...
		\visible<1-2>{
			...
			\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/delivery_delay.pdf}} ;
		}
		\visible<2>{
		...
		\visible<3->{
			...
			\node at (\midX,\midY) {\includegraphics[width=80mm] {explore/delivery_delay_vs_frequency.png}} ;
		}
		\visible<4>{
...
\begin{frame}[t, label=DBSCAN]
	...
	\begin{tikzpicture}
		...
		\visible<1-5>{
			\node at (90mm,75mm) {\includegraphics[width=30mm] {essais/dbscan/pie.pdf}} ;
		}

		\visible<2-3>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/dbscan/LDA.png}} ;
		}
		\visible<3>{
		...
		\visible<4-5>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/dbscan/pairplot.png}} ;
		}
		\visible<5>{
		...
		\visible<6-9>{
			...
			\node at (\midX,\midY+5mm) {\includegraphics[width=60mm] {essais/dbscan/tsne.png}} ;
		}
		\visible<7->{
...
\begin{frame}[t, label=AgglomerativeClustering]
	...
	\begin{tikzpicture}
		...
		\visible<1-5>{
			\node at (90mm,75mm) {\includegraphics[width=30mm] {essais/agglomerative/pie.pdf}} ;
		}

		\visible<2-3>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/agglomerative/LDA.png}} ;
		}
		\visible<3>{
		...
		\visible<4-5>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/agglomerative/pairplot.png}} ;
		}
		\visible<5>{
		...
		\visible<6-9>{
			\node[myShaded] at (\midX,85mm) {TSNE} ;
			\node at (\midX,\midY+5mm) {\includegraphics[width=60mm] {essais/agglomerative/tsne.png}} ;
		}
		\visible<7->{
...
\begin{frame}[t, label=KmeansSilhouette]
	...
	\begin{tikzpicture}
		...
		\visible<2>{
			\node at (\midX,\midY) {\includegraphics[width=80mm]{essais/silhouette_KM_optim.pdf}} ;
		}
		\visible<3->{
			\node at (\midX,\midY) {\includegraphics[width=80mm]{essais/silhouette_KM_sup.pdf}} ;
		}
		\visible<1>{
			\node at (\midX,\midY) {\includegraphics[width=80mm]{essais/silhouette_KM_sub.pdf}} ;
		}
...
\begin{frame}[t, label=Kmeans]
	...
	\begin{tikzpicture}
		...
		\visible<1-5>{
			\node at (90mm,75mm) {\includegraphics[width=30mm] {essais/k_elbow_optim/pie.pdf}} ;
		}
			
		\visible<1>{
			\node[myShaded] at (40mm,85mm) {Diagramme polaire du centre des clusters} ;
			\node at (40mm, \midY) { \includegraphics[width=70mm] {essais/k_elbow_optim/polar_centers.pdf} } ;
		}

		\visible<2-3>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/k_elbow_optim/LDA.png}} ;
		}
		\visible<3>{
		...
		\visible<4-5>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/k_elbow_optim/pairplot.png}} ;
		}
		\visible<5>{
		...
		\visible<6-9>{
			\node[myShaded] at (\midX,85mm) {TSNE} ;
			\node at (\midX,\midY+5mm) {\includegraphics[width=60mm] {essais/k_elbow_optim/tsne.png}} ;
		}
		\visible<7->{
...
\begin{frame}[t, label=KmeansDelay]
	...
	\begin{tikzpicture}
		...
		\visible<1-5>{
			\node at (90mm,75mm) {\includegraphics[width=30mm] {essais/delay/k_elbow_optim/pie.pdf}} ;
		}

		\visible<1>{
			\node[myShaded] at (40mm,85mm) {Diagramme polaire du centre des clusters} ;
			\node at (40mm, \midY) { \includegraphics[width=70mm] {essais/delay/k_elbow_optim/polar_centers.pdf} } ;
		}

		\visible<2-3>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/delay/k_elbow_optim/LDA.png}} ;
		}
		\visible<3>{
			\node[box_style00, myOrng, text width=20mm] at (60mm,70mm) {Séparations bien visibles} ;
		}
		...
		\visible<4-5>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/delay/k_elbow_optim/pairplot.png}} ;
		}
		\visible<5>{
		...
		\visible<6->{
			\node[myShaded] at (\midX,85mm) {TSNE} ;
			\node at (\midX,\midY+5mm) {\includegraphics[width=60mm] {essais/delay/k_elbow_optim/tsne.png}} ;
		}
		\visible<7->{
...
\begin{frame}[t, label=KmeansReviewScore]
	...
	\begin{tikzpicture}
		...
		\visible<1-5>{
			\node at (90mm,75mm) {\includegraphics[width=30mm] {essais/review_score/k_elbow_optim/pie.pdf}} ;
		}

		\visible<1>{
			\node[myShaded] at (40mm,85mm) {Diagramme polaire du centre des clusters} ;
			\node at (40mm, \midY) { \includegraphics[width=70mm] {essais/review_score/k_elbow_optim/polar_centers.pdf} } ;
		}

		\visible<2-3>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/review_score/k_elbow_optim/LDA.png}} ;
		}
		\visible<3>{
			\node[box_style00, myOrng, text width=20mm] at (60mm,70mm) {Séparations bien visibles} ;
		}
		...
		\visible<4-5>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/review_score/k_elbow_optim/pairplot.png}} ;
		}
		\visible<5>{
		...
		\visible<8->{
			\node[text width=70mm, text centered] at (\midX,15mm) {Séparation \alert{cohérente} et \alert{relativement compréhensible}} ;
		}
		\visible<9>{
			\node[text width=90mm, text centered] at (\midX,10mm) {\alert{actionnable}, mais \tit{quid} de la \alert{pertinence} pour la segmentation ?} ;
		}
...
\begin{frame}[t, label=KmeansPaymentType]
	...
	\begin{tikzpicture}
		...
		\visible<1-6>{
			\node at (90mm,75mm) {\includegraphics[width=30mm] {essais/payment_type/k_elbow_optim/pie.pdf}} ;
		}

		\visible<1-2>{
			\node[myShaded] at (40mm,85mm) {Diagramme polaire du centre des clusters} ;
			\node at (40mm, \midY) { \includegraphics[width=70mm] {essais/payment_type/k_elbow_optim/polar_centers.pdf} } ;
			\visible<2>{
		...
		\visible<3-4>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/payment_type/k_elbow_optim/LDA.png}} ;
		}
		\visible<4>{
		...
		\visible<5-6>{
			\node at (\midX,\midY) {\includegraphics[width=80mm] {essais/payment_type/k_elbow_optim/pairplot.png}} ;
		}
		\visible<6>{
		...
		\visible<10>{
			\node[text width=90mm, text centered] at (\midX,10mm) {\alert{Pas nécessairement actionnable} $\rightarrow$ essais possibles avec K-prototype} ;
		}
	\end{tikzpicture}
\end{frame}
...
\begin{frame}[t, label=MaintenancePairplots]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY) {\includegraphics[width=75mm] {simulations/k_means_initial_(k=4)/polar_centers.pdf}} ;
		}
		\visible<2-3>{
		\node at (\midX,\midY) {\includegraphics[width=80mm] {simulations/k_4/pairplot.png}} ;
		\node at (80mm,70mm) {\includegraphics[width=30mm] {simulations/k_4/pie.pdf}} ;
		}
		\visible<3>{
		...
		\node at (\midX-25mm,\midY) {\includegraphics[width=50mm] {simulations/k_means_initial_(k=4)/polar_centers.pdf}} ;
		\node at (\midX+25mm,\midY) {\includegraphics[width=50mm] {simulations/k_means_initial_(k=5)/polar_centers.pdf}} ;
		}
		\visible<5-7>{
			\node[myOrng] at (\midX,8mm) {Nouvelle séparation sur la fréquence} ;
		}
		\visible<6-7>{
		\node at (\midX,\midY) {\includegraphics[width=80mm] {simulations/k_5/pairplot.png}} ;
		\node at (80mm,70mm) {\includegraphics[width=30mm] {simulations/k_5/pie.pdf}} ;
		}
		\visible<7>{
...
\begin{frame}[t, label=MaintenanceCurve]
	...
	\begin{tikzpicture}
		...
		\node at (\midX,\midY+20mm) {\includegraphics[width=80mm] {simulations/k_4/ARI.pdf}} ;

		\visible<2->{
			\node at (\midX,43.5mm) {Évolution du score ARI pour k=5} ;
			\node at (\midX,\midY-20mm) {\includegraphics[width=80mm] {simulations/k_5/ARI.pdf}} ;
		}
